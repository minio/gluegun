...
$(document).ready(function () {
    ...
    $('body').on('click', '.doc-link__items > li > a', function (e) {
        ...
        $('.doc-link__items .doc-link__active').removeClass('doc-link__active'); // Remove active class from previous sidebar item
        $(this).addClass('doc-link__active').fadeIn(300); // Add active class to the sidebar item that was clicked
    });
